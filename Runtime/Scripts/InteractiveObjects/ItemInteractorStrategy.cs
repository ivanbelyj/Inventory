...
public class ItemInteractorStrategy : NetworkBehaviour, IInteractorStrategy
{
    ...
    private IGridSectionInventory _characterInventory;

    private ItemStaticDataManager _itemStaticDataManager;

    private void Awake()
    {
        _itemStaticDataManager = FindAnyObjectByType<ItemStaticDataManager>();
        _characterInventory = GetComponent<IGridSectionInventory>();
    }
